...
void cdda_track_info(uchar *result, int track);
// return info on the given track, result is 7-bytes long

void cdda_read_sector(uchar* p,unsigned long nb_sect,
                      uchar mode_read, uchar mode_addr);
...
void cdda_dos_cooked_read_sector_lba(uchar* p, unsigned long nb_sect);
